...
error_reporting(0);
$query = " SELECT * FROM sub4 where offer_type = 'Wanted Post'";
...
<body>
	<header>
		...
		<div class="Navigation">
			<ul>
				...
				<li style="background: #1abc9c;"><a href="wanted_post.php">Wanted Post</a></li>
			</ul>
		</div>
	...
	<div>
		<div class="adverting_text" >
			<h1 class="text-center"class="boxed">Wanted Post</h1>
		</div>
	</div>

	<!--For View Wanted Post -->
