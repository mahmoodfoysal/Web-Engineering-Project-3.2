...
error_reporting(0);
$query = " SELECT * FROM sub4 where offer_type = 'Advertising of Plot'";
...
<body>
	<header>
		...
		<div class="Navigation">
			<ul>
				...
				<li style="background: #1abc9c;"><a href="advertising_plot.php">Advertising of Plot</a></li> 
	...
	<div>
		<div class="adverting_text" >
			<h1 class="text-center"class="boxed">Advertising of Flat / Plot / Appointment</h1>
		</div>
	</div>

	<!--For View Advertising Post -->
