...
error_reporting(0);
$query = " SELECT * FROM sub4 WHERE offer_type = 'Rent' && property_type = 'Bechelor Mess' ";
...
<body>
			...
			<ul>
				...
				<li style="background: #1abc9c;"><a href="#">For Rent</a>
					<ul>
						...
						<li style="background: #1abc9c;"><a href="bacholor_mess.php">Bachelor Mess</a></li>
	...
	<!--Bachelor Mess Heading -->

	<div>
		<div class="adverting_text" >
			<h1 class="text-center"class="boxed">Rent Becholor Mess</h1>
		</div>
	</div>
