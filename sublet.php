...
error_reporting(0);
$query = " SELECT * FROM sub4 WHERE offer_type = 'Rent' && property_type = 'Sublet' ";
...
<body>
			...
			<ul>
				...
				<li style="background: #1abc9c;"><a href="#">For Rent</a>
					<ul>
						...
						<li style="background: #1abc9c;"><a href="sublet.php">Sublet</a></li>
	...
	<div>
		<div class="adverting_text" >
			<h1 class="text-center"class="boxed">Rent as Sublet</h1>
		</div>
	</div>
