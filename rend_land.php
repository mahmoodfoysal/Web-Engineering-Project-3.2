...
error_reporting(0);
$query = " SELECT * FROM sub4 where offer_type = 'Rending of Land'";
...
<body>
	<header>
		...
		<div class="Navigation">
			<ul>
				...
				<li style="background: #1abc9c;"><a href="rend_land.php">Rending of Land</a></li>
	...
	<!--Rending/Sell of Land Heading -->

	<div>
		<div class="adverting_text" >
			<h1 class="text-center"class="boxed">Rending/Sell of Land</h1>
		</div>
	</div>

	<!--For View Rendig/Sell of Land Post -->
