...
error_reporting(0);
$query = " SELECT * FROM sub4 WHERE offer_type = 'Rent' && property_type = 'Office' ";
...
<body>
			...
			<ul>
				...
				<li style="background: #1abc9c;"><a href="#">For Rent</a>
					<ul>
						...
						<li style="background: #1abc9c;"><a href="office.php">Office</a></li>
					</ul>
				</li>
	...
	<!--Rent of Office Heading -->

	<div>
		<div class="adverting_text" >
			<h1 class="text-center"class="boxed">Rent of Office</h1>
		</div>
	</div>
